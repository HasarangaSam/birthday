...
and more confident in facing challenges.`,
  },
  {
    ...
    text: `There are teachers who teach subjects. There are mentors who shape careers. 
        ...
        {impacts.map((item, index) => (
          ...
          >
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
              ...
              >
                {/* Image */}
                <div className="md:w-1/2 h-[500px] bg-black/20 flex items-center justify-center p-6">
                  <img
                    src={item.image}
                    alt={item.title}
