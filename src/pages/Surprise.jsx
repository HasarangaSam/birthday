...
export default function Surprise() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-black via-purple-950 to-black text-white px-4 sm:px-6 overflow-hidden">
      {/* Background Glow */}
      <div className="absolute w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] md:w-[600px] md:h-[600px] bg-purple-500/20 blur-[120px] md:blur-[180px] rounded-full animate-pulse"></div>

      <div className="relative z-10 text-center w-full max-w-3xl">
        {/* Title */}
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-8 md:mb-12">
          🎁 A Small Surprise
        </h1>
        ...
        <AnimatePresence mode="wait">
          <motion.p
            ...
            className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed min-h-[80px] sm:min-h-[100px]"
          >
            {messages[index]}
          </motion.p>
        </AnimatePresence>
        ...
        {showGift && (
          ...
          >
            <button
              ...
              className="text-6xl sm:text-7xl md:text-8xl hover:scale-110 transition"
            >
              🎁
            </button>

            <p className="mt-4 sm:mt-6 text-sm sm:text-base text-purple-300">
